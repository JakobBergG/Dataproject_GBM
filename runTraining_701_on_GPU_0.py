...
!nnUNet_train 3d_fullres nnUNetTrainerV2 701 1 --npz
...
#%%
!nnUNet_predict -i E:\Jasper\nnUNet\nnUNet_raw_data\Task701_HNROI\ImagesTs -o e:\jasper\nnUnet\nnUNet_prediction_results\Task701_HNROI\fold_0 -t 701 -f 0 -tr nnUNetTrainerV2 -m 3d_fullres
...
#%%
!nnUNet_evaluate_folder -ref E:\Jasper\nnUNet\nnUNet_raw_data\Task701_HNROI\LabelsTs -pred E:\Jasper\nnUNet\nnUNet_prediction_results\Task701_HNROI\fold_0 -l 1 2 3 4

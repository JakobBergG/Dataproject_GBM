...
!nnUNet_train 2d nnUNetTrainerV2 501 1 --npz
!nnUNet_train 2d nnUNetTrainerV2 501 2 --npz
!nnUNet_train 2d nnUNetTrainerV2 501 3 --npz
!nnUNet_train 2d nnUNetTrainerV2 501 4 --npz
#%%

!nnUNet_find_best_configuration -m 2d -t 501 --strict

...
The goal is to train models that are able to segment tumors on planning MR scans (T2 scans) and MR scans with recurrence tumors. And furthermore find out if models should be created specifically to each different hospital
